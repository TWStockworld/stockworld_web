          ...
          <div v-for="airdata in airdatas" :key='airdata'>   
            <el-col :span="20">
              <div class="grid-content bg-purple-dark">
                <el-header><h1>{{airdata.site}}</h1></el-header>
...
//const url = 'https://data.epa.gov.tw/api/v2/aqx_p_07?offset=0&limit=100&api_key=4c4ba288-de84-42fc-9553-c7897a7ba32a';
const url = 'https://data.epa.gov.tw/api/v2/aqx_p_02?offset=0&limit=100&api_key=4c4ba288-de84-42fc-9553-c7897a7ba32a';
